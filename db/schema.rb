...
ActiveRecord::Schema.define(version: 2020_06_13_112446) do

  create_table "art_log_comments", force: :cascade do |t|
    t.integer "user_id"
    t.integer "art_log_id"
    t.text "body"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["art_log_id"], name: "index_art_log_comments_on_art_log_id"
    t.index ["user_id"], name: "index_art_log_comments_on_user_id"
  end

  create_table "art_log_likes", force: :cascade do |t|
    t.integer "user_id"
    t.integer "art_log_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["art_log_id"], name: "index_art_log_likes_on_art_log_id"
    t.index ["user_id"], name: "index_art_log_likes_on_user_id"
  end
  ...
  create_table "exhb_log_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["exhb_log_id"], name: "index_exhb_log_comments_on_exhb_log_id"
    t.index ["user_id"], name: "index_exhb_log_comments_on_user_id"
  end

  create_table "exhb_log_likes", force: :cascade do |t|
    t.integer "user_id"
    t.integer "exhb_log_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["exhb_log_id"], name: "index_exhb_log_likes_on_exhb_log_id"
    t.index ["user_id"], name: "index_exhb_log_likes_on_user_id"
  end
